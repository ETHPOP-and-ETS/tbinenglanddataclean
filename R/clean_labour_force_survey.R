...
clean_labour_force_survey <- function(data_path = "D:/data/LFS/stata",
                                      ...
                                      years_var = list(
                                        ...
                                        '2001' = c('age', 'sex', 'cry01', 'country', 'pwt07', 'eth01', 'ethas', 'cameyr'), # 'cryox', phhwt07?
                                        ...
                                        '2010' = c('AGE', 'SEX', 'CRY01', 'COUNTRY', 'PWT14', 'ETHCEN15',       'CAMEYR'), # 'CRYOX',
                                        '2011' = c('AGE', 'SEX', 'CRY01', 'COUNTRY', 'PWT14', 'ETHGBEUL',       'CAMEYR'), # 'CRYOX7'
                                        '2012' = c('AGE', 'SEX', 'CRY12', 'COUNTRY', 'PWT18', 'ETHGBEUL',       'CAMEYR'), # 'CRYOX7'
                                        '2013' = c('AGE', 'SEX', 'CRY12', 'COUNTRY', 'PWT18', 'ETHGBEUL',       'CAMEYR'), # 'CRYOX7'
                                        '2014' = c('AGE', 'SEX', 'CRY12', 'COUNTRY', 'PWT18', 'ETHGBEUL',       'CAMEYR'), # 'CRYOX7'
